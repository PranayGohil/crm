            ...
            <div className="css-showing-subtask">
                <div className="css-table-head">
                    <div className="css-table-heading css-sec2-heading">
                        <p>
                            Showing <span>124</span> Subtasks
                        </p>
                    </div>
                </div>
                            ...
                            <tr key={idx}>
                                ...
                                <td>
                                    <span className="css-actions">
                                        <a href="ClientAdminPreviewPage"><img src="/SVG/css-eye.svg" alt="view" /></a>
                                    </span>
                                </td>
                            </tr>
                        ))}
...
export default ClientAdminSubtaskTable;
