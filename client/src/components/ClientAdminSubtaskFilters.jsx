...
const filtersData = [
    ...
    { label: 'Stage', options: ['Render', 'Design', 'Design', 'Design', 'Design'] },
];

const ClientAdminSubtaskFilters = () => {
                    ...
                    <div className="cpd-menu-bar">
                        {filtersData.map((filter, index) => (
                            <div className={`btn_main ${activeDropdown === index ? 'open' : ''}`} key={index}>
                                <div
                                    className={`dropdown_toggle${index === 0 ? ' css-menu1' : ''}`}
...
export default ClientAdminSubtaskFilters;
