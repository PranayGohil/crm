              ...
              {dueTasks.length === 0 ? (
                ...
                dueTasks.map((task, index) => {
                  ...
                  if (daysLeft !== null) {
                    ...
                    else if (daysLeft < 14) badgeClass = "badge text-bg-warning";
                  }
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div className="md-assigned-user">
                          <img
                            src={
                              task.assign_to?.profile_pic || "/Image/user.jpg"
                            }
                            alt={task.assign_to?.full_name || "User"}
                          />
                          {task.assign_to?.full_name || "N/A"}
                        </div>
                      </td>
                      <td>
                        {daysLeft !== null ? (
