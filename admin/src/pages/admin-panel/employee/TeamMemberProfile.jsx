...
const TeamMemberProfile = () => {
  ...
  const handleDeleteEmployee = async () => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_URL}/api/employee/delete/${employee._id}`, {
  ...
  const personalDetails = [
    ...
    { label: "Emergency", value: employee.emergency_contact || "N/A", icon: "/SVG/call-vec.svg" },
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2 flex-shrink-0">
            ...
            <button onClick={() => setShowDeleteModal(true)}
              className="flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {employee.profile_pic ? (
              <img src={employee.profile_pic} alt={employee.full_name} className="w-20 h-20 sm:w-28 sm:h-28 rounded-full object-cover border-4 border-white shadow-md flex-shrink-0" />
            ) : (
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <input type={showPassword ? "text" : "password"} value={employee.password || ""} readOnly
