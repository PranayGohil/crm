...
const SubtaskLogs = () => {
  ...
  // Build a running cumulative earned for each completed stage (sorted oldest first for cumulation)
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-800">Subtask Logs</h1>
      ...
      {/* Subtask Info */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Subtask Information</h2>
          ...
          <div>
            ...
            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${subtask.status === "Completed" ? "bg-green-100 text-green-800" :
                subtask.status === "In Progress" ? "bg-yellow-100 text-yellow-800" :
                  subtask.status === "To Do" ? "bg-blue-100 text-blue-800" :
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="bg-gray-50 p-4 rounded-lg text-center border border-gray-100">
              <p className="text-xs text-gray-500 mb-1">Total Contract</p>
            ...
            <div className="bg-green-50 p-4 rounded-lg text-center border border-green-100">
              ...
              <p className="text-xl font-bold text-green-700">₹{earnedAmount.toLocaleString()}</p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg text-center border border-blue-100">
              ...
              <p className="text-xl font-bold text-blue-700">{earningPercent}%</p>
            </div>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sortedTimeLogs.map((log, index) => (
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{getEmployeeName(log.user_id)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {log.start_time ? dayjs(log.start_time).format("DD/MM/YYYY HH:mm") : "N/A"}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {log.end_time ? dayjs(log.end_time).format("DD/MM/YYYY HH:mm") : "Still running"}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
      ...
      {/* ── Stage Completion History with prices ── */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Stage Completion History</h2>
              ...
              <div key={index} className="border-l-4 border-green-500 pl-4 py-2">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-600">
                      {stage.completed_at ? dayjs(stage.completed_at).format("DD/MM/YYYY HH:mm") : "N/A"}
                    </p>
                    {/* ── Stage price earned ── */}
                    {(stage.price || 0) > 0 && (
                      <div className="mt-1">
